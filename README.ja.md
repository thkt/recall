...
このプロジェクトは [arjunkmrm/recall](https://github.com/arjunkmrm/recall) にインスパイアされて作られました。過去の Claude Code セッションを検索可能にするというアイデアはそこから生まれたものです。本プロジェクトは Rust による再実装で、シングルバイナリ・依存なし・高速起動・CJK（日本語・中国語・韓国語）検索対応を特徴としています。
